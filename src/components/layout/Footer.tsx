...
//       <div ref={wallRef} className="overflow-hidden bg-[#050505]">
//         <div className="flex items-end justify-center px-4 pb-4 pt-12 md:pt-16">
//           <div className="flex items-center gap-3 md:gap-4">
//             <h2 className="text-[14vw] font-black leading-none tracking-tighter text-white md:text-[9vw]">
//               Go<span className="text-brand-light">Digital</span>
//             </h2>
//           </div>
//         </div>
//         <div className="mx-auto max-w-7xl border-t border-white/5" />
//       </div>

//       <footer ref={metaRef} className="bg-[#050505] opacity-0">
//         <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 px-6 py-10 md:flex-row md:px-12">
...
//                 key={link.href}
//                 href={link.href}
//                 className="text-sm font-medium text-gray-400 transition-colors hover:text-blue-500"
//               >
//                 {link.label}
//               </TransitionLink>
//             ))}
